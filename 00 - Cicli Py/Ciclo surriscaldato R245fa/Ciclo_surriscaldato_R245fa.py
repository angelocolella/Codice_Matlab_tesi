...
T41_prov = linspace(T4vs+0.1, T4, 500)
...
plot(sls, Tls, color='k')
plot(svss, Tvss, color='k')
plot(s12, T12, color='r')
plot(s22e, T22e, color='r')
plot(s2e3, T2e3, color='r')
plot(s3surr, T3surr, color = 'r')
plot(ssurr4, Tsurr4, color='r')
plot(s41, T41, color='r')
plot(s4ls1, T4ls1, color='r')
title('Piano T-s ciclo surriscaldato R245fa', fontdict=None, loc='center', pad=None)
xlabel('s [kJ/KgK]')
ylabel('T [C]')
