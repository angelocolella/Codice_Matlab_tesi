...
#Definizione dei punti sul piano T-s

sx = [(s1/1000), (s2/1000), (s3/1000), (s4/1000)]
Ty = [(T1-273), (T2-273), (T3-273), (T4-273)]
...
plot(s12, T12, color = colore, linestyle='--', linewidth=1.5)
plot(s22e, T22e, color = colore, linestyle='--', linewidth=1.5)
plot(s2e3, T2e3, color = colore, linestyle='--', linewidth=1.5)
plot(s34, T34, color = colore, linestyle='--', linewidth=1.5)
plot(s41, T41, color = colore, linestyle='--', linewidth=1.5)
plot(s4ls1, T4ls1, color = colore, linestyle='--', linewidth=1.5)

for j in range (len(Ty)):
    plot(sx[j], Ty[j], marker = 'o', color = coloreiso)

title('Piano T-s ciclo reale base R245fa', fontdict=None, loc='center', pad=None, fontsize = 18)


xlabel('s [kJ/KgK]', fontsize = 16)
xticks(fontsize = 16)
ylabel('T [$^\circ$C]', fontsize = 16)
yticks(fontsize = 16)
